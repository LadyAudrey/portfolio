...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className="h-screen flex flex-col w-full bg-gradient-to-b from-blue-950 to-green-950 text-white">
        ...
        <div className="min-w-full md:pt-40 md:px-60 flex flex-row justify-between min-h-0">
          {children}
        </div>
