    ...
    <>
      <div className="flex flex-row justify-between w-full m-10">
        <div className="card bg-gradient-to-b from-green-950 to-blue-950">
          ...
          <p>
            I like coding, puzzles and scavenger hunts. It's fun to brain storm
            and then explore what's possible with these dynamic, well-developed
            tools. I'm grateful to be standing on the shoulders of many coders
            before me. I get to enjoy the tools that coders wished existed,
            figured out how to create, and then I get to use those tools to
            develop the next generation. How cool is that???
          </p>
        </div>
