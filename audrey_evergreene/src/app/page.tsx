    ...
    <main>
      <div className="flex flex-col p-10">
          ...
          <p>
            ...
            clinic. Steering my path towards becoming a front-end web
            development, my passion for untangling complex puzzles and creating
            clean solutions entice me to dive into software engineering.
          </p>
